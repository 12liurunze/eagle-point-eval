...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ee-model-path",
        type=str,
        default="/home/dhz/tmp_model/EAGLE-EYE-Qwen2.5vl-7B-10k-video",
    ...
    parser.add_argument("--model-id", type=str, default="Qwen2.5-VL-7B-Instruct-video-fp16-baseline")
    parser.add_argument(
        "--bench-name",
        type=str,
    ...
    parser.add_argument("--answer-dir", type=str,default="/root/autodl-tmp/eagle-eye/EAGLE_EYE/eagle_eye/outputs_baseline",help="The output answer file.")
