...
jsonl_file = "/root/autodl-tmp/eagle-eye/outputs/Qwen2.5-VL-7B-Instruct-video-fp16-ee-temperature-0.0.jsonl"
jsonl_file_base = "/root/autodl-tmp/eagle-eye/EAGLE_EYE/eagle_eye/outputs_baseline/COCO-caption/Qwen2.5-VL-7B-Instruct-video-fp16-baseline-temperature-0.0.jsonl"
...
print("ratio",np.array(speeds0).mean()/np.array(speeds).mean())
