...
def build_dataset_rank(
    ...
    def preprocess_function(examples, seen_ids):
        ...
        for i in range(len(examples["id"])):
            ...
            turns = conversation.split("<|im_end|>\n")
            cur_len = 0
            ...
            for i, turn in enumerate(turns):
                ...
                if len(parts) != 2:
                    loss_mask[cur_len : cur_len + turn_len] = 0
                    cur_len += turn_len
                    continue
                parts[0] += sep
                instruction_len = len(processor(images=image, text=parts[0], return_tensors='pt').input_ids[0])
