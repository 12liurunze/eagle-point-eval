...
# 示例调用
#frame_list = sample_frames("E:/Datasets/tiny-Kinetics-400/abseiling/_4YTwq0-73Y_000044_000054.mp4")

#print((frame_list))
def setup_model():
    os.environ['HF_ENDPOINT'] = 'https://hf-mirror.com'
    device = 'cuda:0'
    model_id = "/home/dhz/llava-v1.5-7b-hf"
...
def process_video(video_path, processor, model,i):
    ...
    **inputs,
    ...
    return_dict_in_generate=True  # 返回结构化输出
)
    ...
    layer0_stacks = torch.cat(layer0_hidden, dim=1)  # 形状: (1, total_seq_len, hidden_size)
...
video_dir = "/home/dhz/K400/train_256"
