...
parser.add_argument("--basepath", type=str, default="/home/dhz/llava-v1.5-7b-hf")
parser.add_argument(
    "--configpath",
    type=str,
    default="/home/dhz/eagle-eye/EAGLE_EYE/eagle_eye/train/llava_7B_config.json",
)
parser.add_argument("--lr", type=float, default=3e-5)
parser.add_argument("--bs", type=int, default=4)
parser.add_argument("--gradient-accumulation-steps", type=int, default=1)
parser.add_argument(
    "--tmpdir", type=str, default='/home/dhz/llava-instruct-output/get_data_llava_k_11'
)
parser.add_argument(
    "--outdir", type=str, default="/home/dhz/weights/llava_k_11_v2"
)
parser.add_argument(
    "--cpdir", type=str, default="/home/dhz/weights/llava_k_11_v2"
)
