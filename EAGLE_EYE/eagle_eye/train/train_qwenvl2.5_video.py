...
parser.add_argument("--basepath", type=str, default="/home/dhz/Qwen2.5-VL-7B-Instruct")
parser.add_argument(
    "--configpath",
    type=str,
    default="/home/dhz/eagle-eye/EAGLE_EYE/eagle_eye/train/qwenvl2_5_7B_config.json",
)
parser.add_argument("--lr", type=float, default=3e-5)
parser.add_argument("--bs", type=int, default=1)
parser.add_argument("--gradient-accumulation-steps", type=int, default=1)
parser.add_argument(
    "--tmpdir", type=str, default='/home/dhz/k400-output'
)
parser.add_argument(
    "--outdir", type=str, default="/home/dhz/weights/qwen2.5vl_video"
)
parser.add_argument(
    "--cpdir", type=str, default="/home/dhz/weights/qwen2.5vl_video"
)
...
if accelerator.is_main_process:
    ...
    wandb.init(project="eagle-eye", config=train_config)
...
traindatapath = datapath[: int(len(datapath) * 0.8)]
testdatapath = datapath[int(len(datapath) * 0.8) :]
